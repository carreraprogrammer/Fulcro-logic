...
goog.scope(function(){
  com.fulcrologic.fulcro.algorithms.do_not_use.goog$module$goog$object = goog.module.get('goog.object');
});
...
var vec__55410 = ((cljs.core.seq_QMARK_(expr))?cljs.core.ffirst(expr):cljs.core.first(expr));
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55410,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55410,(1),null);
...
var expr__$1 = (function (){var G__55426 = expr;
if(cljs.core.seq_QMARK_(expr)){
return cljs.core.first(G__55426);
} else {
return G__55426;
}
})();
...
if(cljs.core.seq_QMARK_(expr)){
var G__55429 = cljs.core.first(expr);
return (com.fulcrologic.fulcro.algorithms.do_not_use.join_key.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.algorithms.do_not_use.join_key.cljs$core$IFn$_invoke$arity$1(G__55429) : com.fulcrologic.fulcro.algorithms.do_not_use.join_key.call(null,G__55429));
} else {
return expr;
...
var len__4864__auto___55473 = arguments.length;
var i__4865__auto___55474 = (0);
while(true){
if((i__4865__auto___55474 < len__4864__auto___55473)){
args__4870__auto__.push((arguments[i__4865__auto___55474]));

var G__55475 = (i__4865__auto___55474 + (1));
i__4865__auto___55474 = G__55475;
continue;
} else {
}
break;
...
return com.fulcrologic.fulcro.algorithms.do_not_use.deep_merge.cljs$core$IFn$_invoke$arity$variadic(argseq__4871__auto__);
});
...
/** @this {Function} */
(com.fulcrologic.fulcro.algorithms.do_not_use.deep_merge.cljs$lang$applyTo = (function (seq55441){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq55441));
}));
...
if(cljs.core.truth_((function (){var and__4251__auto__ = (s instanceof cljs.core.Keyword);
...
var and__4251__auto____$1 = query;
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [["The composed root query is not valid EQL. The app may crash. See `(comp/get-query ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__55465 = query;
var G__55465__$1 = (((G__55465 == null))?null:cljs.core.meta(G__55465));
var G__55465__$2 = (((G__55465__$1 == null))?null:new cljs.core.Keyword(null,"component","component",1555936782).cljs$core$IFn$_invoke$arity$1(G__55465__$1));
if((G__55465__$2 == null)){
return null;
} else {
return (component_name_fn.cljs$core$IFn$_invoke$arity$1 ? component_name_fn.cljs$core$IFn$_invoke$arity$1(G__55465__$2) : component_name_fn.call(null,G__55465__$2));
}
})()),")`"].join(''),query], null);
}),null)),null,570711270,null);
} else {
}
