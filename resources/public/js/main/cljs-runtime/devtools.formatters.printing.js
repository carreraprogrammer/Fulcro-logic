...
var len__4864__auto___41492 = arguments.length;
var i__4865__auto___41493 = (0);
while(true){
if((i__4865__auto___41493 < len__4864__auto___41492)){
args__4870__auto__.push((arguments[i__4865__auto___41493]));

var G__41494 = (i__4865__auto___41493 + (1));
i__4865__auto___41493 = G__41494;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq41423){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41424,G__41425,seq41423__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__41445_SHARP_){
return (!((cljs.core.meta(p1__41445_SHARP_) == null)));
})))){
...
var map__41461 = opts;
var map__41461__$1 = cljs.core.__destructure_map(map__41461);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41461__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e41462){var _e__40811__auto__ = e41462;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e41464){var _e__40811__auto__ = e41464;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__41472 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__41473 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__41473);

try{devtools.formatters.state.add_object_to_current_path_info_BANG_(obj);

var map__41474 = opts;
var map__41474__$1 = cljs.core.__destructure_map(map__41474);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41474__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__41472);
}});
...
var temp__5751__auto___41514 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___41514)){
var managed_print_level_41516 = temp__5751__auto___41514;
var _STAR_print_level_STAR__orig_val__41481_41517 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__41482_41518 = managed_print_level_41516;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__41482_41518);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__41476_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__41476_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__41481_41517);
}} else {
job_fn();
}
