...
var id = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__58855_SHARP_){
return cljs.core.re_matches(/^#.*/,p1__58855_SHARP_);
}),tokens));
var classes = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__58856_SHARP_){
return cljs.core.re_matches(/^\..*/,p1__58856_SHARP_);
}),tokens);
...
var G__58858 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"classes","classes",2037804510),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(com.fulcrologic.fulcro.dom_common.remove_separators,classes))], null);
if(cljs.core.truth_(sanitized_id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__58858,new cljs.core.Keyword(null,"id","id",-1388402092),sanitized_id);
} else {
return G__58858;
}
} else {
...
var map__58860 = com.fulcrologic.fulcro.dom_common.parse(kw);
var map__58860__$1 = cljs.core.__destructure_map(map__58860);
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__58860__$1,new cljs.core.Keyword(null,"classes","classes",2037804510),cljs.core.PersistentVector.EMPTY);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58860__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
var G__58861 = (function (){var or__4253__auto__ = props;
...
var G__58861__$1 = ((cljs.core.seq(classes))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__58861,new cljs.core.Keyword(null,"className","className",-1983287057),com.fulcrologic.fulcro.dom_common.combined_classes(classes,existing_classes)):G__58861);
if(cljs.core.truth_(id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__58861__$1,new cljs.core.Keyword(null,"id","id",-1388402092),id);
} else {
return G__58861__$1;
}
}
...
var strcls = (function (){var or__4253__auto__ = new cljs.core.Keyword(null,"className","className",-1983287057).cljs$core$IFn$_invoke$arity$1(props);
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return "";
