...
var i_49743 = (0);
while(true){
if((i_49743 < arr.length)){
(arr[i_49743] = null);

var G__49744 = (i_49743 + (1));
i_49743 = G__49744;
continue;
} else {
}
...
var i_49773 = (self__.level + (1));
while(true){
if((i_49773 <= (new_level + (1)))){
(update[i_49773] = self__.header);

var G__49774 = (i_49773 + (1));
i_49773 = G__49774;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_49778 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_49778[i]));
} else {
x__$2.forward.push((((i < links_49778.length))?(links_49778[i]):null));
}

if((i < links_49778.length)){
(links_49778[i] = x__$2);
} else {
links_49778.push(x__$2);
}
...
var i_49789 = (0);
while(true){
if((i_49789 <= self__.level)){
var links_49790 = (update[i_49789]).forward;
if((x__$1 === (((i_49789 < links_49790.length))?(links_49790[i_49789]):null))){
(links_49790[i_49789] = (x__$1.forward[i_49789]));

var G__49791 = (i_49789 + (1));
i_49789 = G__49791;
continue;
} else {
var G__49792 = (i_49789 + (1));
i_49789 = G__49792;
continue;
}
} else {
...
var G__49795 = nx;
var G__49796 = (level__$1 - (1));
x = G__49795;
level__$1 = G__49796;
continue;
} else {
var G__49797 = x;
var G__49798 = (level__$1 - (1));
x = G__49797;
level__$1 = G__49798;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__49808 = nx;
var G__49809 = (level__$1 - (1));
x = G__49808;
level__$1 = G__49809;
continue;
} else {
var G__49811 = x;
var G__49812 = (level__$1 - (1));
x = G__49811;
level__$1 = G__49812;
continue;
}
