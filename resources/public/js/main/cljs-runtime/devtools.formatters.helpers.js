...
var G__41416 = devtools.prefs.pref(v);
v = G__41416;
continue;
} else {
return v;
...
}catch (e41356){var _e__40811__auto__ = e41356;
return false;
}})();
...
}catch (e41366){var _e__40811__auto__ = e41366;
return false;
}})();
...
}catch (e41368){var _e__40811__auto__ = e41368;
return false;
}}
}
});
...
var vec__41390 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41390,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41390,(1),null);
...
return cljs.core.some((function (p1__41399_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41399_SHARP_);
}),template);
});
