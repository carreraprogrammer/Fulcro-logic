...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50184_SHARP_){
return expound.printer.str_width(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__50184_SHARP_,i))));
}),rows));
});
expound.printer.max_row_height = (function expound$printer$max_row_height(row){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50187_SHARP_){
return cljs.core.count(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50187_SHARP_)));
}),row));
});
...
var G__50195 = ["%-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(column_widths,i)),"s"].join('');
var G__50196 = v;
return (expound.printer.format.cljs$core$IFn$_invoke$arity$2 ? expound.printer.format.cljs$core$IFn$_invoke$arity$2(G__50195,G__50196) : expound.printer.format.call(null,G__50195,G__50196));
}),row);
}),multi_row);
}),multi_rows);
});
...
var columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50216_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50216_SHARP_)).length),"-"));
}),header);
var header_columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50218_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50218_SHARP_)).length),"="));
}),header);
...
var iter__4652__auto__ = (function expound$printer$multirow_$_iter__50223(s__50224){
...
var row_idx = cljs.core._nth(c__4650__auto__,i__50225);
cljs.core.chunk_append(b__50226,(function (){var iter__4652__auto__ = ((function (i__50225,row_idx,c__4650__auto__,size__4651__auto__,b__50226,s__50224__$2,temp__5753__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__50223_$_iter__50231(s__50232){
return (new cljs.core.LazySeq(null,((function (i__50225,row_idx,c__4650__auto__,size__4651__auto__,b__50226,s__50224__$2,temp__5753__auto__,split_row_contents){
return (function (){
var s__50232__$1 = s__50232;
while(true){
var temp__5753__auto____$1 = cljs.core.seq(s__50232__$1);
if(temp__5753__auto____$1){
var s__50232__$2 = temp__5753__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__50232__$2)){
var c__4650__auto____$1 = cljs.core.chunk_first(s__50232__$2);
var size__4651__auto____$1 = cljs.core.count(c__4650__auto____$1);
var b__50234 = cljs.core.chunk_buffer(size__4651__auto____$1);
if((function (){var i__50233 = (0);
while(true){
if((i__50233 < size__4651__auto____$1)){
var col_idx = cljs.core._nth(c__4650__auto____$1,i__50233);
cljs.core.chunk_append(b__50234,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__50612 = (i__50233 + (1));
i__50233 = G__50612;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50234),expound$printer$multirow_$_iter__50223_$_iter__50231(cljs.core.chunk_rest(s__50232__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50234),null);
}
} else {
var col_idx = cljs.core.first(s__50232__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__50223_$_iter__50231(cljs.core.rest(s__50232__$2)));
}
} else {
return null;
}
...
});})(i__50225,row_idx,c__4650__auto__,size__4651__auto__,b__50226,s__50224__$2,temp__5753__auto__,split_row_contents))
,null,null));
});})(i__50225,row_idx,c__4650__auto__,size__4651__auto__,b__50226,s__50224__$2,temp__5753__auto__,split_row_contents))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50226),expound$printer$multirow_$_iter__50223(cljs.core.chunk_rest(s__50224__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50226),null);
}
} else {
var row_idx = cljs.core.first(s__50224__$2);
return cljs.core.cons((function (){var iter__4652__auto__ = ((function (row_idx,s__50224__$2,temp__5753__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__50223_$_iter__50244(s__50245){
return (new cljs.core.LazySeq(null,(function (){
var s__50245__$1 = s__50245;
while(true){
var temp__5753__auto____$1 = cljs.core.seq(s__50245__$1);
if(temp__5753__auto____$1){
var s__50245__$2 = temp__5753__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__50245__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__50245__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__50247 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__50246 = (0);
while(true){
if((i__50246 < size__4651__auto__)){
var col_idx = cljs.core._nth(c__4650__auto__,i__50246);
cljs.core.chunk_append(b__50247,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__50615 = (i__50246 + (1));
i__50246 = G__50615;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50247),expound$printer$multirow_$_iter__50223_$_iter__50244(cljs.core.chunk_rest(s__50245__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50247),null);
}
} else {
var col_idx = cljs.core.first(s__50245__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__50223_$_iter__50244(cljs.core.rest(s__50245__$2)));
}
} else {
return null;
}
...
});})(row_idx,s__50224__$2,temp__5753__auto__,split_row_contents))
;
return iter__4652__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(cljs.core.count(row)));
})(),expound$printer$multirow_$_iter__50223(cljs.core.rest(s__50224__$2)));
}
} else {
return null;
}
...
var rows = cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [column_keys], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50291_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(p1__50291_SHARP_,column_keys);
}),map_rows));
...
var form = (function (){var G__50334 = via;
var G__50334__$1 = (((G__50334 == null))?null:cljs.core.last(G__50334));
if((G__50334__$1 == null)){
return null;
} else {
return cljs.spec.alpha.form(G__50334__$1);
}
})();
...
var seq__50337_50644 = cljs.core.seq(problems);
var chunk__50338_50645 = null;
var count__50339_50646 = (0);
var i__50340_50647 = (0);
while(true){
if((i__50340_50647 < count__50339_50646)){
var p_50649 = chunk__50338_50645.cljs$core$IIndexed$_nth$arity$2(null,i__50340_50647);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_50649) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__50653 = seq__50337_50644;
var G__50654 = chunk__50338_50645;
var G__50655 = count__50339_50646;
var G__50656 = (i__50340_50647 + (1));
seq__50337_50644 = G__50653;
chunk__50338_50645 = G__50654;
count__50339_50646 = G__50655;
i__50340_50647 = G__50656;
continue;
} else {
var temp__5753__auto___50661 = cljs.core.seq(seq__50337_50644);
if(temp__5753__auto___50661){
var seq__50337_50663__$1 = temp__5753__auto___50661;
if(cljs.core.chunked_seq_QMARK_(seq__50337_50663__$1)){
var c__4679__auto___50666 = cljs.core.chunk_first(seq__50337_50663__$1);
var G__50668 = cljs.core.chunk_rest(seq__50337_50663__$1);
var G__50669 = c__4679__auto___50666;
var G__50670 = cljs.core.count(c__4679__auto___50666);
var G__50671 = (0);
seq__50337_50644 = G__50668;
chunk__50338_50645 = G__50669;
count__50339_50646 = G__50670;
i__50340_50647 = G__50671;
continue;
} else {
var p_50674 = cljs.core.first(seq__50337_50663__$1);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_50674) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__50679 = cljs.core.next(seq__50337_50663__$1);
var G__50680 = null;
var G__50681 = (0);
var G__50682 = (0);
seq__50337_50644 = G__50679;
chunk__50338_50645 = G__50680;
count__50339_50646 = G__50681;
i__50340_50647 = G__50682;
continue;
}
} else {
}
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,k,((cljs.core.qualified_keyword_QMARK_(k))?k:(function (){var or__4253__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50336_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),cljs.core.name(p1__50336_SHARP_));
}),specs));
...
expound.printer.summarize_key_clause = (function expound$printer$summarize_key_clause(p__50377){
var vec__50378 = p__50377;
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50378,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50378,(1),null);
var G__50382 = branch;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50382__$1)].join('')));

}
});
expound.printer.missing_key = (function expound$printer$missing_key(form){
var vec__50388 = cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","contains-key-pred","expound.spec/contains-key-pred",-989075236),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,(2)));
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50388,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50388,(1),null);
var G__50392 = branch;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50392__$1)].join('')));
...
var len__4864__auto___50773 = arguments.length;
var i__4865__auto___50777 = (0);
while(true){
if((i__4865__auto___50777 < len__4864__auto___50773)){
args__4870__auto__.push((arguments[i__4865__auto___50777]));

var G__50784 = (i__4865__auto___50777 + (1));
i__4865__auto___50777 = G__50784;
continue;
} else {
}
break;
...
/** @this {Function} */
(expound.printer.format.cljs$lang$applyTo = (function (seq50404){
...
var keys = expound.printer.keywords(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50442_SHARP_){
return expound.printer.missing_key(new cljs.core.Keyword(null,"pred","pred",1927423397).cljs$core$IFn$_invoke$arity$1(p1__50442_SHARP_));
}),problems));
...
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p1__50443_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__50443_SHARP_,"key");
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__50449){
var vec__50450 = p__50449;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50450,(0),null);
...
var _STAR_print_newline_STAR__orig_val__50457_50817 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50458_50818 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50459_50819 = true;
var _STAR_print_fn_STAR__temp_val__50460_50820 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50459_50819);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50460_50820);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50458_50818);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50457_50817);
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50465_SHARP_){
return expound.ansi.color.cljs$core$IFn$_invoke$arity$variadic(p1__50465_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"correct-key","correct-key",1087492967)], 0));
...
var vec__50523 = clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(s));
...
var line = first__50525;
var lines = seq__50524__$1;
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(first_line_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)].join('')], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50490_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(rest_lines_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50490_SHARP_)].join('');
}),lines)));
}));
...
while(true){
var vec__50550 = in$;
var seq__50551 = cljs.core.seq(vec__50550);
var first__50552 = cljs.core.first(seq__50551);
var seq__50551__$1 = cljs.core.next(seq__50551);
var k = first__50552;
var rst = seq__50551__$1;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(displayed_form,new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k)),(function (){var G__50556 = show_valid_values_QMARK_;
var G__50557 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k);
var G__50558 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__50556,G__50557,G__50558) : expound.printer.summary_form.call(null,G__50556,G__50557,G__50558));
})(),new cljs.core.Keyword("expound.problems","irrelevant","expound.problems/irrelevant",2090226124));
} else {
if(((cljs.core.map_QMARK_(form)) && (expound.paths.kvps_QMARK_(k)))){
var G__50852 = show_valid_values_QMARK_;
var G__50853 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(k));
var G__50854 = rst__$1;
show_valid_values_QMARK_ = G__50852;
form = G__50853;
in$ = G__50854;
continue;
} else {
if(cljs.core.associative_QMARK_(form)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(displayed_form,k,(function (){var G__50560 = show_valid_values_QMARK_;
var G__50561 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(form,k);
var G__50562 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__50560,G__50561,G__50562) : expound.printer.summary_form.call(null,G__50560,G__50561,G__50562));
})());
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.seq_QMARK_(form)))){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__50565 = show_valid_values_QMARK_;
var G__50566 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,k);
var G__50567 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__50565,G__50566,G__50567) : expound.printer.summary_form.call(null,G__50565,G__50566,G__50567));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.set_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__50569 = show_valid_values_QMARK_;
var G__50570 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__50571 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__50569,G__50570,G__50571) : expound.printer.summary_form.call(null,G__50569,G__50570,G__50571));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.list_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.List.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__50576 = show_valid_values_QMARK_;
var G__50577 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__50578 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__50576,G__50577,G__50578) : expound.printer.summary_form.call(null,G__50576,G__50577,G__50578));
})()));
} else {
...
var max_width = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50579_SHARP_){
return ((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50579_SHARP_)).length);
...
var map__50585 = problem;
var map__50585__$1 = cljs.core.__destructure_map(map__50585);
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50585__$1,new cljs.core.Keyword("expound","form","expound/form",-264680632));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50585__$1,new cljs.core.Keyword("expound","in","expound/in",-1900412298));
var map__50586 = opts;
var map__50586__$1 = cljs.core.__destructure_map(map__50586);
var show_valid_values_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__50586__$1,new cljs.core.Keyword(null,"show-valid-values?","show-valid-values?",-587258094),false);
...
var s = (function (){var _STAR_print_namespace_maps_STAR__orig_val__50590 = cljs.core._STAR_print_namespace_maps_STAR_;
var _STAR_print_namespace_maps_STAR__temp_val__50591 = false;
(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__temp_val__50591);
...
}finally {(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__orig_val__50590);
}})();
var vec__50587 = cljs.core.re_find(regex,s);
var seq__50588 = cljs.core.seq(vec__50587);
var first__50589 = cljs.core.first(seq__50588);
var seq__50588__$1 = cljs.core.next(seq__50588);
var line = first__50589;
var first__50589__$1 = cljs.core.first(seq__50588__$1);
var seq__50588__$2 = cljs.core.next(seq__50588__$1);
var prefix = first__50589__$1;
var _more = seq__50588__$2;
