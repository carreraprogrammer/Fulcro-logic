...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_44202 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_44202(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_44203 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_44203(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_44204 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_44204(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_44205 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_44205(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_44209 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_44209(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_44211 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_44211(reader);
}
});
...
var G__44227 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__44228 = s.append(c);
c = G__44227;
s = G__44228;
continue;
}
