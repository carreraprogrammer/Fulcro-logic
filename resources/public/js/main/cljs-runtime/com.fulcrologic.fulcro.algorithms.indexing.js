...
com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_ = (function com$fulcrologic$fulcro$algorithms$indexing$index_query_STAR_(prop__GT_classes,p__58522){
var map__58524 = p__58522;
var map__58524__$1 = cljs.core.__destructure_map(map__58524);
var ast = map__58524__$1;
var parent_component = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58524__$1,new cljs.core.Keyword(null,"component","component",1555936782));
var parent_children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58524__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (idx,p__58527){
var map__58528 = p__58527;
var map__58528__$1 = cljs.core.__destructure_map(map__58528);
var child_ast = map__58528__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58528__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var dispatch_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58528__$1,new cljs.core.Keyword(null,"dispatch-key","dispatch-key",733619510));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58528__$1,new cljs.core.Keyword(null,"children","children",-940561982));
var G__58530 = idx;
var G__58530__$1 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__58530,dispatch_key,parent_key):G__58530);
var G__58530__$2 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__58530__$1,key,parent_key):G__58530__$1);
var G__58530__$3 = (((key instanceof cljs.core.Keyword))?update_index(G__58530__$2,key,parent_key):G__58530__$2);
if(cljs.core.seq(children)){
return (com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2(G__58530__$3,child_ast) : com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.call(null,G__58530__$3,child_ast));
} else {
return G__58530__$3;
}
...
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58538__$1,new cljs.core.Keyword(null,"children","children",-940561982));
 ...
 */
com.fulcrologic.fulcro.algorithms.indexing.link_query_props = (function com$fulcrologic$fulcro$algorithms$indexing$link_query_props(p__58541){
var map__58542 = p__58541;
var map__58542__$1 = cljs.core.__destructure_map(map__58542);
var ast = map__58542__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58542__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58542__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
}),null)),null,134366354,null);

var map__58549 = app__$1;
var map__58549__$1 = cljs.core.__destructure_map(map__58549);
var state_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58549__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366));
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58549__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var map__58550 = cljs.core.deref(runtime_atom);
var map__58550__$1 = cljs.core.__destructure_map(map__58550);
var root_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58550__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","root-class","com.fulcrologic.fulcro.application/root-class",-719803119));
...
var map__58563 = com.fulcrologic.fulcro.raw.components.any__GT_app(this$);
var map__58563__$1 = cljs.core.__destructure_map(map__58563);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58563__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
...
if(cljs.core.truth_((function (){var and__4251__auto__ = ident;
...
var map__58583 = com.fulcrologic.fulcro.raw.components.any__GT_app(this$);
var map__58583__$1 = cljs.core.__destructure_map(map__58583);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58583__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var cls = com.fulcrologic.fulcro.raw.components.component_type(this$);
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"action","action",-811238024),(function com$fulcrologic$fulcro$algorithms$indexing$action(p__58596){
var map__58597 = p__58596;
var map__58597__$1 = cljs.core.__destructure_map(map__58597);
var app__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58597__$1,new cljs.core.Keyword(null,"app","app",-560961707));
var _STAR_after_render_STAR__orig_val__58600_58640 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__58601_58641 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__58601_58641);
...
}),null)),null,-1906573166,null);
}
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__58600_58640);
}
return null;
}),new cljs.core.Keyword(null,"result-action","result-action",-1254630246),(function (env){
var _STAR_after_render_STAR__orig_val__58607 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__58608 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__58608);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__58607);
}})], null);
}));
